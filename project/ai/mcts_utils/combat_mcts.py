...
class CombatMCTS():
    ...
    def __init__(self, game, bot):
        ...
        self.actions = {"left": lambda: self.simu_self.set_speed([-1,0]),
                   ...
                   "turnc": lambda: self.simu_self.set_ang_speed(1),
                   "turncc": lambda: self.simu_self.set_ang_speed(-1),
        ...
        self.self_actions = {"left": lambda: self.self_bot.set_speed([-1,0]),
                   ...
                   "turnc": lambda: self.self_bot.set_ang_speed(1),
                   "turncc": lambda: self.self_bot.set_ang_speed(-1),
